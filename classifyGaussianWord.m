...
function mfccModelG = train()
    ...
    mfccModelG = fitcnb(training,label);
    save('training_dataG.mat','mfccModelG');
end

function specFluxModelG = train2()
    training2 = [];
    label2 = [];
    type = '';
    filenames=dir('training/*.wav');
    for i=1:length(filenames)
     ...
     specFluxModelG = fitcnb(training2,label2);  
     save('training_data2.mat','specFluxModelG');
end
